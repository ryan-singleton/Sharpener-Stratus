...
public sealed class PageCursor<T>
{
    ...
    ///     take place).
    /// </param>
    public PageCursor(int? startPage, int? pageSize,
        Func<int, int, Task<Outcome<Page<T>>>> func)
    {
        _hasMore = true;
...
#pragma warning restore CA2012
    ...
    /// </summary>
    public Outcome<Page<T>> Current { get; private set; }
    ...
    public async ValueTask<bool> MoveNextAsync()
    {
        ...
        {
            Current = page;
            _hasMore = page.PageOffset == page.PageCount;
            if (!_hasMore)
            {
                return false;
            }
